...
export default function MaleHairOne(props) {
	const group = useRef();
	const { nodes, materials, animations } = useGLTF("/MaleHairOne.glb");
	const { actions } = useAnimations(animations, group);
	return (
		<group ref={group} {...props} dispose={null}>
			<group name="Male_C">
				<group name="Male_C_1" position={[671.82, 0.43, -125.81]} scale={1.01}>
					<group
						name="Character"
						position={[0, 0.86, 0]}
									...
									>
										...
										>
											...
											>
												<primitive
													object={
														nodes.Set_Character_Character_Head_Male_Hair_1
													}
												/>
											</group>
											<group
												name="Set_Character_Character_Neck_Male_Hair_1"
												scale={0.99}
											>
												<group
													name="Set_Character_Character_Head_1_Male_Hair_1"
													position={[0.1, 0, 0]}
													rotation={[0, 0, -0.28]}
												>
													<skinnedMesh
														name="Set_Character_Male_Hair_1"
														geometry={nodes.Set_Character_Male_Hair_1.geometry}
														material={materials.Male_Hair_1}
														skeleton={nodes.Set_Character_Male_Hair_1.skeleton}
														morphTargetDictionary={
															nodes.Set_Character_Male_Hair_1
																.morphTargetDictionary
														}
										...
										<group
											name="Set_Character_Character_Spine2_Male_Hair_1"
											scale={0.99}
										/>
									</group>
									<group
										name="Set_Character_Character_Spine1_Male_Hair_1"
										scale={0.99}
									/>
								</group>
								<group
									name="Set_Character_Character_Spine_Male_Hair_1"
									scale={0.99}
								/>
							</group>
						</group>
						<group name="Set_Character_Character_Male_Hair_1" scale={0.99} />
					</group>
					<group name="Set_Character_Male_Hair_1_1" scale={0.99} />
				</group>
			</group>
		</group>
	);
...
useGLTF.preload("/MaleHairOne.glb");
