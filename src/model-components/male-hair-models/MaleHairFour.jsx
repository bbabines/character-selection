...
export default function MaleHairFour(props) {
	const group = useRef();
	const { nodes, materials, animations } = useGLTF("/MaleHairFour-v1.glb");
	const { actions } = useAnimations(animations, group);
	return (
		<group ref={group} {...props} dispose={null}>
			<group name="Male_A">
				<group name="Male_A_1" position={[0, 0, 0]} scale={1.03}>
					<group
						name="Character"
						position={[0, 0.86, 0]}
									...
									>
										...
										>
											...
											>
												<primitive
													object={
														nodes.Set_Character_Character_Head_Male_Hair_3
													}
												/>
											</group>
										</group>
					...
					<group name="Set_Character_Male_Hair_3" scale={0.97}>
						<skinnedMesh
							name="Set_Character_Male_Hair_3_1"
							geometry={nodes.Set_Character_Male_Hair_3_1.geometry}
							material={materials.Male_Hair_3}
							skeleton={nodes.Set_Character_Male_Hair_3_1.skeleton}
							morphTargetDictionary={
								nodes.Set_Character_Male_Hair_3_1.morphTargetDictionary
							}
							morphTargetInfluences={
								nodes.Set_Character_Male_Hair_3_1.morphTargetInfluences
							}
...
useGLTF.preload("/MaleHairFour-v1.glb");
