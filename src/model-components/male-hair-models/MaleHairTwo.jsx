...
export default function MaleHairTwo(props) {
	const group = useRef();
	const { nodes, materials, animations } = useGLTF("/MaleHairTwo.glb");
		...
		<group ref={group} {...props} dispose={null}>
			<group name="Male_A">
				<group name="Male_A_1" position={[672.34, 0, -127.25]} scale={1.03}>
									...
									>
										...
										>
											...
											>
												<primitive
													object={
														nodes.Set_Character_Character_Head_Male_Hair_2
													}
												/>
											</group>
										</group>
					...
					<group name="Set_Character_Male_Hair_2" scale={0.97}>
						<skinnedMesh
							name="Set_Character_Male_Hair_2_1"
							geometry={nodes.Set_Character_Male_Hair_2_1.geometry}
							material={materials.Male_Hair_2}
							skeleton={nodes.Set_Character_Male_Hair_2_1.skeleton}
							morphTargetDictionary={
								nodes.Set_Character_Male_Hair_2_1.morphTargetDictionary
							}
							morphTargetInfluences={
								nodes.Set_Character_Male_Hair_2_1.morphTargetInfluences
							}
...
useGLTF.preload("/MaleHairTwo.glb");
