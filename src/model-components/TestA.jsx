...
export default function TestA(props, { hairTypeSelection }) {
	const group = useRef();
	const { nodes, materials, animations } = useGLTF("/PrunedA.glb");
	const { actions, names } = useAnimations(animations, group);

	console.log(hairTypeSelection);
