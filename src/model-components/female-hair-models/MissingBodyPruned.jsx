...
export default function MissingBodyPruned(props) {
	const group = useRef();
	const { nodes, materials, animations } = useGLTF("/missingBodyPruned.glb");
	...
	return (
		<group ref={group} {...props} dispose={null}>
			<group name="Female_A" position={[0, -1.8, -0.03]} scale={2}>
...
useGLTF.preload("/missingBodyPruned.glb");
