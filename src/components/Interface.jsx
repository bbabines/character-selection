					...
					<div className="right-side-container">
						...
						<div className="description-container">
							<p className="description">
								Welcome to the character selection screen of Legends of
								Aetheria!
							</p>
							{/* <p>
						...
						with danger, magic, and unimaginable challenges.
							...
							<p>
								As you prepare to shape your destiny, choose your character
								wisely, for their unique abilities and skills will be determined
								by your faction choice.
							</p>
							<div
								className={`${
							...
							>
								...
								<p>
									...
									skilled in espionage, assassination, and subterfuge, operating
									in the shadows to shape the fate of Aetheria.
								</p>
							</div>
							<div
								className={`${
							...
							>
								...
								<p>
									...
									warriors and valiant defenders. Committed to upholding justice
									and protecting the innocent, they stand as beacons of hope in
									a world plagued by darkness. Clad in gleaming armor, their
									ranks are filled with knights, paladins, and righteous
									champions who wield weapons imbued with holy power. of
									Aetheria.
								</p>
								<p>Skill & Abilities:</p>
								<p>
									You main abilities stem from your two-handed weapons which
									deal devastating damage to your enemies.
								</p>
								<p>Gear & Playstyle:</p>
								<p>
									In your face sword and board fighting. As an Order of the
									Silver Dawn, you will not be afraid to rush into a crowd of
									enemies with your plate armor and hack n' slash your way to
									victory
								</p>
							</div>
							<div
							...
							>
								...
								covert operations, and the ability to strike from the shadows,
								the Shadow Syndicate plays a dangerous game, seeking to control
								the fate of Aetheria without revealing their true intentions.
								Embrace the shadows and unlock the true potential of deception
								and manipulation as you navigate a world where nothing is as it
								seems.
							</p>
						</div>
						{/* </Html> */}
